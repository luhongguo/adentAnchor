...
MODIFY COLUMN EnCode  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '编码' AFTER Id,
MODIFY COLUMN Name  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称' AFTER ParentId,
MODIFY COLUMN Layer  int(11) NULL DEFAULT NULL COMMENT '层次' AFTER Name,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER Layer,
MODIFY COLUMN IsTree  char(1) NULL DEFAULT NULL COMMENT '是否树形菜单' AFTER SortCode,
MODIFY COLUMN DeleteMark  char(1) NULL DEFAULT NULL COMMENT '删除标记' AFTER IsTree,
MODIFY COLUMN IsEnabled  char(1) NULL DEFAULT NULL COMMENT '是否启用' AFTER DeleteMark,
MODIFY COLUMN Remark  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注' AFTER IsEnabled,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER Remark,
MODIFY COLUMN CreateTime datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser,
MODIFY COLUMN ModifyUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人' AFTER CreateTime,
MODIFY COLUMN ModifyTime  datetime NULL DEFAULT NULL COMMENT '修改时间' AFTER ModifyUser;
...
ALTER TABLE sys_itemsdetail
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN ItemId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级' AFTER Id,
MODIFY COLUMN EnCode  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '编码' AFTER ItemId,
MODIFY COLUMN Name  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选项名称' AFTER EnCode,
MODIFY COLUMN IsDefault  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否默认' AFTER Name,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER IsDefault,
MODIFY COLUMN DeleteMark  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '删除标记' AFTER SortCode,
MODIFY COLUMN IsEnabled  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否启用' AFTER DeleteMark,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER IsEnabled,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser,
MODIFY COLUMN ModifyUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人' AFTER CreateTime,
MODIFY COLUMN ModifyTime  datetime NULL DEFAULT NULL COMMENT '修改时间' AFTER ModifyUser;
...
ALTER TABLE sys_log
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '发生时间' AFTER Id,
MODIFY COLUMN LogLevel  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日志等级' AFTER CreateTime,
MODIFY COLUMN Operation  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作模块' AFTER LogLevel,
MODIFY COLUMN Message  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日志消息' AFTER Operation,
MODIFY COLUMN RealName  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实姓名' AFTER Account,
MODIFY COLUMN IP  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作人IP' AFTER RealName,
MODIFY COLUMN IPAddress  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作人IP归属地' AFTER IP,
MODIFY COLUMN StackTrace  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '堆栈信息' AFTER Browser;
...
ALTER TABLE sys_organize
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN ParentId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级' AFTER Id,
MODIFY COLUMN Layer  int(11) NULL DEFAULT NULL COMMENT '层次' AFTER ParentId,
MODIFY COLUMN EnCode  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '编码' AFTER Layer,
MODIFY COLUMN FullName  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '全称' AFTER EnCode,
MODIFY COLUMN Type  int(11) NULL DEFAULT NULL COMMENT '分类' AFTER FullName,
MODIFY COLUMN ManagerId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '负责人' AFTER Type,
MODIFY COLUMN TelePhone  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '固话' AFTER ManagerId,
MODIFY COLUMN WeChat  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信' AFTER TelePhone,
MODIFY COLUMN Fax  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '传真' AFTER WeChat,
MODIFY COLUMN Email  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱' AFTER Fax,
MODIFY COLUMN Address  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址' AFTER Email,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER Address,
MODIFY COLUMN DeleteMark  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '删除标记' AFTER SortCode,
MODIFY COLUMN IsEnabled  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否启用' AFTER DeleteMark,
MODIFY COLUMN Remark  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注' AFTER IsEnabled,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER Remark,
...
INSERT INTO Sys_Organize(Id, ParentId, Layer, EnCode, FullName, Type, ManagerId, TelePhone, WeChat, Fax, Email, Address, SortCode, DeleteMark, IsEnabled, Remark, CreateUser, CreateTime, ModifyUser, ModifyTime) VALUES ('771b628b-e43c-4592-b1ef-70ea23b0e3f2', '0', null, 'company', '某公司', '0', '某人', null, null, null, 'aa@qq.com', null, '10', '0', '1', null, null, null, 'admin', '2018-04-04 11:42:33.857');
...
MODIFY COLUMN ParentId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级' AFTER Id,
MODIFY COLUMN Layer  int(11) NULL DEFAULT NULL COMMENT '层次' AFTER ParentId,
MODIFY COLUMN Name  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称' AFTER EnCode,
MODIFY COLUMN JsEvent  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件' AFTER Name,
MODIFY COLUMN Icon  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图标' AFTER JsEvent,
MODIFY COLUMN Url  varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '链接' AFTER Icon,
MODIFY COLUMN Remark  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注' AFTER Url,
MODIFY COLUMN Type  int(11) NULL DEFAULT NULL COMMENT '模块类型：1-菜单 2-按钮' AFTER Remark,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER Type,
MODIFY COLUMN IsPublic  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '是否公开' AFTER SortCode,
MODIFY COLUMN IsEnable  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '是否可用' AFTER IsPublic,
MODIFY COLUMN IsEdit  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '允许编辑' AFTER IsEnable,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER DeleteMark,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser,
MODIFY COLUMN ModifyUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人' AFTER CreateTime,
MODIFY COLUMN ModifyTime  datetime NULL DEFAULT NULL COMMENT '修改时间' AFTER ModifyUser;
...
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN OrganizeId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '组织ID' AFTER Id,
MODIFY COLUMN EnCode  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '编号' AFTER OrganizeId,
MODIFY COLUMN Type  smallint(6) NULL DEFAULT NULL COMMENT '分类：1-角色2-岗位' AFTER EnCode,
MODIFY COLUMN Name  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称' AFTER Type,
MODIFY COLUMN AllowEdit  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否可编辑' AFTER Name,
MODIFY COLUMN DeleteMark  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '删除标记' AFTER AllowEdit,
MODIFY COLUMN IsEnabled  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否启用' AFTER DeleteMark,
MODIFY COLUMN Remark  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注' AFTER IsEnabled,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER Remark,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER SortCode,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser,
MODIFY COLUMN ModifyUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人' AFTER CreateTime,
MODIFY COLUMN ModifyTime  datetime NULL DEFAULT NULL COMMENT '修改时间' AFTER ModifyUser;
...
ALTER TABLE sys_roleauthorize
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN RoleId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色ID' AFTER Id,
MODIFY COLUMN ModuleId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模块ID' AFTER RoleId,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER ModuleId,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser;
...
INSERT INTO Sys_RoleAuthorize (Id, RoleId, ModuleId, CreateUser, CreateTime) VALUES ('3e7e6244-080b-49a6-9fb5-654af2e0fd33', 'a3a3857c-51fb-43a6-a7b5-3a612e887b3a', '855f3590-b233-4224-aaff-47fb95c8353d', null, null)					   ;
...
MODIFY COLUMN Id  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键' FIRST ,
MODIFY COLUMN Account  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '账户' AFTER Id,
MODIFY COLUMN RealName  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实姓名' AFTER Account,
MODIFY COLUMN NickName  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '昵称' AFTER RealName,
MODIFY COLUMN Avatar  varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像' AFTER NickName,
MODIFY COLUMN Gender  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性别' AFTER Avatar,
MODIFY COLUMN Birthday  datetime NULL DEFAULT NULL COMMENT '生日' AFTER Gender,
MODIFY COLUMN MobilePhone  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机' AFTER Birthday,
MODIFY COLUMN Email  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱' AFTER MobilePhone,
MODIFY COLUMN Signature  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '签名' AFTER Email,
MODIFY COLUMN Address  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址' AFTER Signature,
MODIFY COLUMN CompanyId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '领导ID' AFTER Address,
MODIFY COLUMN DepartmentId  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '组织ID' AFTER CompanyId,
MODIFY COLUMN IsEnabled  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否启用' AFTER DepartmentId,
MODIFY COLUMN SortCode  int(11) NULL DEFAULT NULL COMMENT '排序码' AFTER IsEnabled,
MODIFY COLUMN DeleteMark  char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '删除标记' AFTER SortCode,
MODIFY COLUMN CreateUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人' AFTER DeleteMark,
MODIFY COLUMN CreateTime  datetime NULL DEFAULT NULL COMMENT '创建时间' AFTER CreateUser,
MODIFY COLUMN ModifyUser  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人' AFTER CreateTime,
...
INSERT INTO Sys_User (Id, Account, RealName, NickName, Avatar, Gender, Birthday, MobilePhone, Email, Signature, Address, CompanyId, DepartmentId, IsEnabled, SortCode, DeleteMark, CreateUser, CreateTime, ModifyUser, ModifyTime) VALUES ('d1ef3dcd-2c7d-4e8f-8f29-9f73625dd5df', 'admin', '周某人', '周某人', '/Content/framework/images/avatar.png', '1', '1991-07-22 00:00:00.000', '18800000000', '6000000000@qq.com', '啦啦啦啦啦啦啦啦啦咯1', '江苏苏州', null, 'a93c66e2-b8dc-4d00-84ed-e6071b5f5318', '1', '1', '0', 'admin', '2017-03-22 10:58:43.107', 'admin', '2017-09-13 11:59:35.807');
