        ...
        $.ajax({
            ...
            success: function (result, status, xhr) {
                if (result.result == true) {
                    ...
                    if (_config.paged) {
                        ...
                        laypage.render({
                            ...
                            limit: _pageConfig.pageSize,
                            //分页栏目
                            layout: ['prev', 'page', 'next', 'count'],//limit（条目选项区域）
                ...
                if (_config.checkbox) {
                    ...
                    //        $that.on('click', function () {
                    //            //多选。
                    //            var currState = $(this).children('td').eq(0).children("input[type='checkbox']")[0].checked;
                    //            if (currState) {
                    //                $(this).children('td').eq(0).children("input[type='checkbox']")[0].checked = false;
                    //                $(this).removeAttr('style');
                    //            } else {
                    //                $(this).children('td').eq(0).children("input[type='checkbox']")[0].checked = true;
                    //                $(this).css('background-color', '#F3F7F9');
                    //            }
                    //            form.render('checkbox');
                    //        });
                    //    }
